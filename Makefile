...
#    Updated: 2020/02/25 16:50:00 by mbourand         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_NAME= main.c parser.c parserutils.c ray.c utils.c ft_numberlen.c \
			...
			actions.c hud.c minimap.c scope.c format_description.c utils2.c
OBJ_NAME= $(SRC_NAME:.c=.o)

INC= -I incs/ -I libft/
SRC= $(addprefix $(SRC_PATH), $(SRC_NAME))
OBJ= $(addprefix $(OBJ_PATH), $(OBJ_NAME))
LIB= -L libft/ -lft -lmlx -framework OpenGL -framework AppKit -lm
DEF= \033[0m
RED= \033[31;1m
GRN= \033[32;1m
YEL= \033[33;1m
